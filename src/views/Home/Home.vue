<template>
  <div>
    <LegalSystem :data="info.indexLegalSystemDTO" :loading="loading" />
    <CaseStatistics class="margin-top-lg" :data="info.indexCaseDTO" :loading="loading" />
    <LegalReview class="margin-top-lg" :data="info.indexLegalReviewDTO" :loading="loading" />
    <FirmExternal class="margin-top-lg" :data="info.indexOutsideLawFirmDTO" :loading="loading" />
    <Propaganda class="margin-top-lg" :data="info.indexPublicityDTO" :loading="loading" />
  </div>
</template>
