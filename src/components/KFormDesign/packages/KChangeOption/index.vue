<template>
  <div class="option-change-container">
    ...
    <a-row v-else-if="type === 'responsive'" :gutter="8">
      <div class="option-change-box" v-for="(val, index) in value" :key="index" style="display:inline-block;height:auto;">
        <a-col :span="20">
          <a-row type="flex">
            <a-col :span="4"> xs: </a-col>
            <a-col :span="12">
              <a-input-number style="width:100%" :max="24" :min="1" v-model="val.xs" placeholder="栅格值" />
            </a-col>
            <a-col :span="8" class="pre"> &lt;768px </a-col>
          </a-row>
          <a-row>
            <a-col :span="4"> sm: </a-col>
            <a-col :span="12">
              <a-input-number style="width:100%" :max="24" :min="1" v-model="val.sm" placeholder="栅格值" />
            </a-col>
            <a-col :span="8" class="pre"> &ge;768px </a-col>
          </a-row>
          <a-row>
            <a-col :span="4"> md: </a-col>
            <a-col :span="12">
              <a-input-number style="width:100%" :max="24" :min="1" v-model="val.md" placeholder="栅格值" />
            </a-col>
            <a-col :span="8" class="pre"> &ge;992px </a-col>
          </a-row>
          <a-row>
            <a-col :span="4"> lg: </a-col>
            <a-col :span="12">
              <a-input-number style="width:100%" :max="24" :min="1" v-model="val.lg" placeholder="栅格值" />
            </a-col>
            <a-col :span="8" class="pre"> &ge;1200px </a-col>
          </a-row>
          <a-row>
            <a-col :span="4"> xl: </a-col>
            <a-col :span="12">
              <a-input-number style="width:100%" :max="24" :min="1" v-model="val.xl" placeholder="栅格值" />
            </a-col>
            <a-col :span="8" class="pre"> &ge;1920px </a-col>
          </a-row>
